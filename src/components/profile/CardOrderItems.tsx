...
interface CardOrderItemsProps {
  dataItems: OrderItem[];
  orderStatus: string; // Menambahkan status pesanan
  totalPrice: number; // Menambahkan total price
  totalItems: number; // Menambahkan total items
}
...
const CardOrderItems = ({
  ...
  return (
    <div className="w-full max-w-2xl mx-auto rounded-lg shadow-lg overflow-hidden border border-gray-300 bg-white">
      <div className="bg-gray-100 px-5 py-4 border-b border-gray-300">
        <h3 className="text-lg font-semibold text-gray-900">Order Details :</h3>
        <div className="text-gray-600 text-sm">Status: {orderStatus}</div>
      </div>
